...
TaskStack uses **Outfit** (display/brand) and **Inter** (body/UI), loaded via `google\_fonts` package.
...
- `icon\_size`: 24dp standard, 20dp in dense contexts, 48dp for hero icons
